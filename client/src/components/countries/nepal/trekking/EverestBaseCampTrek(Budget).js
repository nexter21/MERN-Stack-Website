...
export default class EverestBaseCampTrekBudget extends Component {
  componentDidMount() {
    window.scrollTo(0, 0);
  }
  render() {
    return (
      <div>
        <OneDestination
          title="Everest Base Camp Trek (Budget) – 14 Days"
          url="https://www.caravanoutdoors.com/wp-content/uploads/2016/07/everest-base-camp.jpg"
          ...
          itineraryes={[
            [
              ...
              [
                "\nAt your arrival in Kathmandu, a member of our team will greet and receive you at the airport. You will be transferred to your hotel. Our representative will brief on your arrival about the trip. The rest of the day is yours."
              ]
            ],
            [
          ...
          includedListData={[
            ...
            "Entire lodging during the trek",
            "Hotel with Breakfast during the trek",
          ...
          promoOffer={["Everest Base Camp Trek (Budget) – 14 Days", "$ 949USD"]}
          details={[
            "14 days",
