...
class Details extends Component {
  ...
  onClick = e => {
    ...
    this.props.sendPromoData(["Annapurna Base Camp Trek- 11 Days", "$849"]);
  };
  ...
  onSubmit = async e => {
    ...
    const newPromoClient = {
      ...
      destination: "Annapurna Base Camp Trek - 11 Days",
      ...
      <section className="details">
        ...
        <div className="container" id="details">
          <div className="row">
            ...
            <div className="col-sm-6 col-6">
              <h3>
                849 USD (<strike style={{ color: "grey" }}>1150 USD</strike>)
              </h3>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 col-6">
              <h3>Customizable Trek Package</h3>
            </div>
          </div>
        </div>
        {bookNowContent}
